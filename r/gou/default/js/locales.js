;(function (global, factory) {
   ...
   factory(global.moment)
    ...
    function relativeTimeWithPlural(number, withoutSuffix, timeType) {
        var format = {
        ...
        if (timeType === 'm') {
            ...
            return number + ' ' + plural(format[timeType], +number);
        }
    }
    ...
    function relativeTimeWithMutation(number, withoutSuffix, timeType) {
        var format = {
            'mm': 'munutenn',
            'MM': 'miz',
            'dd': 'devezh'
        };
        return number + ' ' + mutation(format[timeType], number);
    }
    ...
    function translate(number, withoutSuffix, timeType) {
        var result = number + ' ';
        switch (timeType) {
            case 'ss':
                if (number === 1) {
    ...
    function translate$1(number, withoutSuffix, timeType, isFuture) {
        var result = number + ' ';
        switch (timeType) {
    ...
    function processRelativeTime(number, withoutSuffix, timeType, isFuture) {
        var format = {
        ...
        return withoutSuffix ? format[timeType][0] : format[timeType][1];
    }
    ...
    function processRelativeTime$1(number, withoutSuffix, timeType, isFuture) {
        var format = {
            'm': ['eine Minute', 'einer Minute'],
            'h': ['eine Stunde', 'einer Stunde'],
            'd': ['ein Tag', 'einem Tag'],
    ...
    function processRelativeTime$2(number, withoutSuffix, timeType, isFuture) {
        var format = {
            'm': ['eine Minute', 'einer Minute'],
            'h': ['eine Stunde', 'einer Stunde'],
            'd': ['ein Tag', 'einem Tag'],
    ...
    moment.defineLocale('el', {
        ...
        calendar : function (timeType, mom) {
            var output = this._calendarEl[timeType],
                hours = mom && mom.hours();
    ...
    function processRelativeTime$3(number, withoutSuffix, timeType, isFuture) {
        var format = {
        ...
        if (withoutSuffix) {
            return format[timeType][2] ? format[timeType][2] : format[timeType][1];
        }
        return isFuture ? format[timeType][0] : format[timeType][1];
    }
    ...
    function translate$2(number, withoutSuffix, timeType, isFuture) {
        var result = '';
        switch (timeType) {
            case 's':
    ...
    function processRelativeTime$4(number, withoutSuffix, timeType, isFuture) {
        var format = {
    ...
    function translate$3(number, withoutSuffix, timeType) {
        var result = number + ' ';
        switch (timeType) {
            case 'ss':
                if (number === 1) {
    ...
    function translate$4(number, withoutSuffix, timeType, isFuture) {
        var num = number;
        switch (timeType) {
            case 's':
    ...
    function translate$5(number, withoutSuffix, timeType, isFuture) {
        var result = number + ' ';
        switch (timeType) {
            case 's':
    ...
    function processRelativeTime$5(number, withoutSuffix, timeType, isFuture) {
        var format = {
    ...
    function translateSeconds(number, withoutSuffix, timeType, isFuture) {
        if (withoutSuffix) {
    ...
    function translateSingular(number, withoutSuffix, timeType, isFuture) {
        return withoutSuffix ? forms(timeType)[0] : (isFuture ? forms(timeType)[1] : forms(timeType)[2]);
    }
    function special(number) {
        return number % 10 === 0 || (number > 10 && number < 20);
    }
    function forms(timeType) {
        return units[timeType].split('_');
    }
    function translate$6(number, withoutSuffix, timeType, isFuture) {
        var result = number + ' ';
        if (number === 1) {
            return result + translateSingular(number, withoutSuffix, timeType[0], isFuture);
        } else if (withoutSuffix) {
            return result + (special(number) ? forms(timeType)[1] : forms(timeType)[0]);
        } else {
            if (isFuture) {
                return result + forms(timeType)[1];
            } else {
                return result + (special(number) ? forms(timeType)[1] : forms(timeType)[2]);
            }
        }
    }
    ...
    function relativeTimeWithPlural$1(number, withoutSuffix, timeType) {
        return number + ' ' + format(units$1[timeType], number, withoutSuffix);
    }
    function relativeTimeWithSingular(number, withoutSuffix, timeType) {
        return format(units$1[timeType], number, withoutSuffix);
    }
    ...
    var translator = {
        ...
        translate: function (number, withoutSuffix, timeType) {
            var wordKey = translator.words[timeType];
    ...
    function translate$7(number, withoutSuffix, timeType, isFuture) {
        switch (timeType) {
            case 's':
    ...
    function translate$8(number, withoutSuffix, timeType) {
        var result = number + ' ';
        switch (timeType) {
            case 'ss':
    ...
    function relativeTimeWithPlural$2(number, withoutSuffix, timeType) {
        var format = {
                'ss': 'secunde',
                'mm': 'minute',
                'hh': 'ore',
        ...
        return number + separator + format[timeType];
    }
    ...
    function relativeTimeWithPlural$3(number, withoutSuffix, timeType) {
        var format = {
            'ss': withoutSuffix ? 'секунда_секунды_секунд' : 'секунду_секунды_секунд',
        ...
        if (timeType === 'm') {
            ...
            return number + ' ' + plural$4(format[timeType], +number);
        }
    }
    ...
    function translate$9(number, withoutSuffix, timeType, isFuture) {
        var result = number + ' ';
        switch (timeType) {
            case 's':  // a few seconds / in a few seconds / a few seconds ago
    ...
    function processRelativeTime$6(number, withoutSuffix, timeType, isFuture) {
        var result = number + ' ';
        switch (timeType) {
            case 's':
    ...
    var translator$1 = {
        ...
        translate: function (number, withoutSuffix, timeType) {
            var wordKey = translator$1.words[timeType];
            if (timeType.length === 1) {
                return withoutSuffix ? wordKey[0] : wordKey[1];
            } else {
    ...
    var translator$2 = {
        ...
        translate: function (number, withoutSuffix, timeType) {
            var wordKey = translator$2.words[timeType];
            if (timeType.length === 1) {
                return withoutSuffix ? wordKey[0] : wordKey[1];
            } else {
    ...
    function processRelativeTime$7(number, withoutSuffix, timeType, isFuture) {
        var format = {
        ...
        return isFuture ? format[timeType][0] : (withoutSuffix ? format[timeType][0] : format[timeType][1]);
    }
    ...
    function relativeTimeWithPlural$4(number, withoutSuffix, timeType) {
        var format = {
        ...
        if (timeType === 'm') {
            ...
            return number + ' ' + plural$6(format[timeType], +number);
        }
    }
